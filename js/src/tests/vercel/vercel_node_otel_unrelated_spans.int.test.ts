...
test("nested generateText", async () => {
  ...
  await tracer.startActiveSpan("sdk-startup-sequence", {}, async () => {
    await tracer.startActiveSpan("pre-startup-validation", {}, async () => {});
    sdk.start();
    await tracer.startActiveSpan(
  ...
  await tracer.startActiveSpan("uuid-generation-ceremony", {}, async () => {
    await tracer.startActiveSpan("checking-entropy-levels", {}, async () => {});
  ...
  await tracer.startActiveSpan("wrapper-execution-phase", {}, async () => {
    await tracer.startActiveSpan("invoking-the-chosen-one", {}, async () => {});
    await tracer.startActiveSpan(
    ...
    await wrapper();
    await tracer.startActiveSpan("celebrating-completion", {}, async () => {});
  });
