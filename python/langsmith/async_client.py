    ...
    async def update_commit_tags(
        ...
        *,
        ...
        Args:
            ...
            commit_id: The UUID of the commit to tag.
            tags: A single tag or list of tags to apply.

        Raises:
            httpx.HTTPStatusError: If a tag creation request fails.
        """
        ...
        tag_list = [tags] if isinstance(tags, str) else tags
        for tag in tag_list:
            await self._delete_commit_tag(prompt_owner_and_name, tag)
        await self._create_commit_tags(prompt_owner_and_name, commit_id, tag_list)
