...
if TYPE_CHECKING:
    ...
    Address = Any  # type: ignore[assignment]

_PROJECT_NAME = contextvars.ContextVar[Optional[str]]("_PROJECT_NAME", default=None)
# The whole `Address`, never unpacked: a new dimension needs no new variable.
_ADDRESS = contextvars.ContextVar[Optional["Address"]]("_ADDRESS", default=None)
...
_GLOBAL_ADDRESS: Optional["Address"] = None
